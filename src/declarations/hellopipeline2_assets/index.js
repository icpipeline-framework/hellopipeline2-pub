...
import { idlFactory } from './hellopipeline2_assets.did.js';
export { idlFactory } from './hellopipeline2_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HELLOPIPELINE2_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hellopipeline2_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hellopipeline2_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hellopipeline2_assets.did.js")._SERVICE>}
 */
export const hellopipeline2_assets = createActor(canisterId);
