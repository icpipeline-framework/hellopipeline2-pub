...
import { idlFactory } from './hellopipeline2.did.js';
export { idlFactory } from './hellopipeline2.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.HELLOPIPELINE2_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./hellopipeline2.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the hellopipeline2 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./hellopipeline2.did.js")._SERVICE>}
 */
export const hellopipeline2 = createActor(canisterId);
